...
public class Datos {
	...
	public double calcMedia() throws Exception {
		int i = 0;
		double sum = 0;
		for (double x : datos) {
			if (x >= min && x <= max) {
			...
			throw new Exception("No hay datos en el rango especificado");
		}
		return sum / i;
	}
	
	public double calcDesvTipica() throws Exception {
