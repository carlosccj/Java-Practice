...
public class TestRunnerContadorPalabrasSig {
	//----------------------------------------------------------------------
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	public static class JUnitTestContadorPalabrasSig {
		...
		public void setUp() {
			...
			cp1 = new ContadorPalabrasSig(2, noSig);
		}
		@After
		...
		@Test(timeout = 1000)
		public void contadorPalabrasSigCtorTest2() {
			ContadorPalabrasSig cp2 = new ContadorPalabrasSig(noSig);
			assertEquals("\n> Error: cp2.toString():",
						 normalize("[]"),
		...
		@Test(timeout = 1000)
		public void contadorPalabrasSigCtorTest4() throws Exception {
			try {
				createFile("noSigInputData.txt", noSigInputData);
				ContadorPalabrasSig cp2 = new ContadorPalabrasSig(2, "noSigInputData.txt", delimiters);
				assertEquals("\n> Error: cp2.toString():",
							 normalize("[]"),
							 normalize(cp2.toString()));
				cp2.incluyeTodas(inputData, delimiters);
