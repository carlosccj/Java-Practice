...
public class PruebaLibreriaOfertaFlex {
	public static void main(String[] args) {
		...
		String [] auts = {"George Orwell", "Isaac Asimov"};
		OfertaAutor x = new OfertaAutor(20, auts);
		LibreriaOfertaFlex a = new LibreriaOfertaFlex(x);
		...
		System.out.println("PrecioFinal(Isaac Asimov, La Fundación): " + df3.format(a.getPrecioFinal("Isaac Asimov", "La Fundación")));
		System.out.println("PrecioFinal(william gibson, neuromante): " + a.getPrecioFinal("william gibson", "neuromante"));
		System.out.println("PrecioFinal(Isaac Asimov, Segunda Fundación): " + df3.format(a.getPrecioFinal("Isaac Asimov", "Segunda Fundación")));
		System.out.println("PrecioFinal(Isaac Newton, Arithmetica Universalis): " + a.getPrecioFinal("Isaac Newton", "Arithmetica Universalis"));
	}
